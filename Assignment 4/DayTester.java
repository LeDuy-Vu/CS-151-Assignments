public class DayTester
{
	public static void main(String[] args) throws IllegalArgumentException
	{
		try
		{
			Day dayError = new Day (0, 21, 12) ;
		}
		catch (IllegalArgumentException ex)
		{
			System.out.println("Should print error: " + ex) ;
		}
		
		try
		{
			Day dayError = new Day (2019, 13, 1) ;
		}
		catch (IllegalArgumentException ex)
		{
			System.out.println("Should print error: " + ex) ;
		...
		try
		{
			Day dayError = new Day (2019, 10, 33) ;
		}
		catch (IllegalArgumentException ex)
		{
			System.out.println("Should print error: " + ex) ;
		...
		try
		{
			Day dayError = new Day (1582, 10, 7) ;
		}
		catch (IllegalArgumentException ex)
		{
			System.out.println("Should print error: " + ex) ;
		...
		try
		{
			Day dayError = new Day (2019, 2, 29) ;
		}
		catch (IllegalArgumentException ex)
		{
			System.out.println("Should print error: " + ex) ;
		...
		try
		{
			Day dayError = new Day (1500, 2, 30) ;
		}
		catch (IllegalArgumentException ex)
		{
			System.out.println("Should print error: " + ex) ;
		...
		try
		{
			Day dayError = new Day (2019, 11, 31) ;
		}
		catch (IllegalArgumentException ex)
		{
			System.out.println("Should print error: " + ex + "\n") ;
